   ...
   <div class="container">
							...
							<table class="table">
								...
								<tbody>
									<tr>
										<td>陳中和</td>
										<td>黃怡娟</td>
										<td>陳穩焜、陳佳儒、鄭怡君、許惠美、黃吟雯、黃莉琴、張夆悊、賴素玲、黃敬哲、張成芝、陳淑珍、楊雅琪</td>
									</tr>
	...
	<div class="container">
		<div class="row justify-content-center">
			<a href="committee_01.php"><button class="btn btn-primary"><i class="icofont icofont-simple-left"></i>上一頁</button></a>
		</div>
	</div>
