   ...
   <div class="container">
				...
				<div class="card p-10">
					<div class="card-header">
						<div class="card-header-left">
							<h4 class="heard_tetx text-c-orenge">醫院事務委員會</h4>
						</div>
					</div>				
					...
					<div class="card-block table-border-style">
						<div class="table-responsive">
							<table class="table">
								...
								<tbody>
									<tr>
										<td><a href="committee_01-01.php">委員會名單</a></td>
										<td>106.12.26</td>
									</tr>
									<tr>
										<td><a href="committee_01-02.php">組織章程</a></td>
										<td>105.11.29</td>
									</tr>
									<tr>
										<td><a href="#"></a></td>
	...
	<div class="container">
		<div class="row justify-content-center">
			<a href="index.php"><button class="btn btn-primary"><i class="icofont icofont-home"></i>首頁</button></a>
		</div>
	</div>
