   ...
   <div class="container">
				...
				<div class="card p-10">
					<div class="card-header">
						<div class="card-header-left">
							<h4 class="heard_tetx text-c-orenge">醫療品質委員會</h4>
						</div>
					</div>				
							...
							<table class="table">
								...
								<tbody>
									<tr>
										<td>黃怡娟</td>
										<td>張成芝</td>
										<td>陳中和、陳穩焜、陳佳儒、鄭怡君、許惠美、黃莉琴、張夆悊、賴素玲、黃敬哲、陳淑珍、楊雅琪</td>
									</tr>
	...
	<div class="container">
		<div class="row justify-content-center">
			<a href="committee_02.php"><button class="btn btn-primary"><i class="icofont icofont-simple-left"></i>上一頁</button></a>
		</div>
	</div>
