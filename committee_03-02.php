   ...
   <div class="container">
				...
				<div class="card p-10">
					<div class="card-header">
						<div class="card-header-left">
							<h4 class="heard_tetx text-c-orenge">TPR通報系統之學習案例</h4>
						</div>
					</div>				
							...
							<table class="table">
								...
								<tbody>
									<tr>
										<td>No.1</td>
										<td>2005年</td>
										<td><a href="">使用抗生素後導致過敏性休克</a></td>
									</tr>
									<tr>
										<td>No.2</td>
										<td>2005年</td>
										<td><a href="">人工呼吸道管路意外</a></td>
									</tr>
									<tr>
										<td>No.3</td>
										<td>2006年</td>
										<td><a href="">院內藥品供應中斷案例</a></td>
									</tr>
									<tr>
										<td>No.4</td>
										<td>2006年</td>
										<td><a href="">跌倒事件學習案例</a></td>
									</tr>
									<tr>
										<td>No.5</td>
										<td>2006年</td>
										<td><a href="">醫療照護事件</a></td>
									</tr>
								</tbody>
							</table>
						</div>
	...
	<div class="container">
		<div class="row justify-content-center">
			<a href="committee_03.php"><button class="btn btn-primary"><i class="icofont icofont-simple-left"></i>上一頁</button></a>
		</div>
	</div>
