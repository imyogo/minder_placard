   ...
   <div class="container">
				...
				<div class="card p-10">
					<div class="card-header">
						<div class="card-header-left">
							<h4 class="heard_tetx text-c-orenge">教育訓練委員會</h4>
						</div>
					</div>				
						...
						<div class="table-responsive">
							<table class="table">
								...
								<tbody>
									...
									<tr>
										<td><a href="">精神疾病診斷及治療</a></td>
									</tr>
									<tr>
										<td><a href="">護理倫理與倫理議題討論</a></td>
									</tr>
									<tr>
										<td><a href="">精神科社會工作內容簡介</a></td>
									</tr>
									<tr>
										<td><a href="">臨床心理室簡介</a></td>
									</tr>
								</tbody>
							</table>
						</div>
	...
	<div class="container">
		<div class="row justify-content-center">
			<a href="committee_05.php"><button class="btn btn-primary"><i class="icofont icofont-simple-left"></i>上一頁</button></a>
		</div>
	</div>
