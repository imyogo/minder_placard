				...
				<div class="card">
					<div class="card-header">
						<div class="card-header-left">
							<h4 class="heard_tetx text-c-orenge">明德醫院附設精神護理之家各科室</h4>
						</div>
					</div>				
					...
					<div class="card-block">
						<div class="row">
							<div class="col-lg-4 col-xl-3 col-sm-12">
								<div class="badge-box">
									<a href=""><div class="sub-title">護理組</div></a>
									<p>附件</p>
									<a href="hospital_list_home_a_01.php"><label class="badge badge-success">職員名單</label></a>
									<a href="#"><label class="badge badge-success">工作手冊</label></a>
									<a href="#"><label class="badge badge-success">護理行政業務手冊</label></a>

								</div> 
							</div> 
							<div class="col-lg-4 col-xl-3 col-sm-12">
								<div class="badge-box">
									<a href=""><div class="sub-title">照服組</div></a>
									<p>附件</p>
									<a href="#"><label class="badge badge-success">職員名單</label></a>
									<a href="#"><label class="badge badge-success">工作手冊</label></a>
								</div> 
							</div> 
							<div class="col-lg-4 col-xl-3 col-sm-12">
								<div class="badge-box">
									<a href=""><div class="sub-title">行政組</div></a>
									<p>附件</p>
									<a href="hospital_list_home_c_01.php"><label class="badge badge-success">職員名單</label></a>
									<a href="#"><label class="badge badge-success">工作手冊</label></a>
								</div> 
							</div> 
							<div class="col-lg-4 col-xl-3 col-sm-12">
								<div class="badge-box">
									<a href=""><div class="sub-title">社工組</div></a>
									<p>附件</p>
									<a href=""><label class="badge badge-success">職員名單</label></a>
									<a href="#"><label class="badge badge-success">工作手冊</label></a>
								</div> 
							...
							<div class="col-lg-4 col-xl-3 col-sm-12">
								<div class="badge-box">
									<a href=""><div class="sub-title">職能治療室</div></a>
									<p>附件</p>
									<a href=""><label class="badge badge-success">職員名單</label></a>
									<a href="#"><label class="badge badge-success">工作手冊</label></a>
								</div> 
							...
							<div class="col-lg-4 col-xl-3 col-sm-12">
								<div class="badge-box">
									<a href=""><div class="sub-title">社會工作室</div></a>
									<p>附件</p>
									<a href=""><label class="badge badge-success">職員名單</label></a>
									<a href="#"><label class="badge badge-success">工作手冊</label></a>
								</div> 
