	...
	<div class="container">
			<div class="row justify-content-center mt-5">
				<div class="col-12 col-md-6">
					<a href="hospital_list.html"><button class="btn btn-primary btn-outline-primary mb-2 btn-block"><i class="icofont icofont-first-aid"></i> 明德醫院各科室</button></a>
				</div>
				<div class="col-12 col-md-6">
    	...
    	<div class="row justify-content-center mt-3">
    		...
    		<div class="col-12 col-md-4">
				<a href="#"><button class="btn btn-danger btn-round btn-outline-danger mb-2 btn-block" data-toggle="modal" href="#myratio">本院護病比</button></a> 	
    		</div>
    		--->
    	</div>
			<div class="row justify-content-center mt-3">
		...
		<div class="row">
			<div class="col-12 col-md-4">
				...
				<div class="left_box_in mt-5">
					<h4 class="heard_tetx text-c-blue"><i class="icofont-id-card icofont-2x"></i> 0123456789</h4>
					<a href="#"><button type="button" class="btn btn-primary">
						<i class="icofont-computer"></i> 進入系統</button>
					</a>
					<a href="#"><button type="button" class="btn btn btn-danger">
						<i class="icofont-logout"></i> 登 出</button>
					</a>
				</div>
...
<!--彈出視窗 護病比
	<div class="modal fade" id="myratio"> <!--fade淡入、淡出的轉場效果
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title text-c-orenge">明德醫院護病比</h4>
					<button type="button" class="close" data-dismiss="modal">&times;</button>
				</div>
				<div class="modal-body">
					<table class="table table-striped table-bordered mb-5"> <!--table-striped 表格交替顏色 table-borderd 表格有邊框
						<thead>
							<tr align="center" valign="middle">
								<th class="text-center">109年</th>
								<th class="text-center">護病比</th>
							</tr>
						</thead>
						<tbody>
							<tr align="center" valign="middle">
